...
#
# Adapted from lecture_i2dl/exercises/python/convert.py for this course.
...
# Fill these in for your own run of the course before generating PDFs.
# Left blank rather than guessed, so no PDF ships with a wrong course/term/author.
COURSE_TITLE = 'Advanced Artificial Intelligence and Machine Learning'
COURSE_TERM = None  # e.g. 'Summer Term 2026'
LECTURERS = None  # e.g. 'Jane Doe, John Smith'
...
def main():
    ...
    # If no argument is given, list all template mds.
        ...
        template_pattern = TEMPLATE_ROOT + r'/py-lab-\d{2}-template\.md'
