...
\begin{vbframe}{Computational graphs}
  ...
  \begin{minipage}{0.5\textwidth}
    \begin{figure}
      \centering
        \includegraphics[width=4.6cm]{figure/compgraph1.png}
...
\begin{frame}{Chain rule of calculus: Example 2}
  \small
   ...
   \begin{figure}
    \centering
      \scalebox{0.22}{\includegraphics{figure/chain_tree.png}}
  \end{figure}
...
\begin{frame} {Computational Graph: Neural Net}
  \begin{figure}
      \centering
        \scalebox{0.55}{\includegraphics{figure/neo_comp.png}}
...
\begin{vbframe}{Backward Computation and Caching}
\begin{itemize}
...
\begin{itemize}
\item Caching this subexpression as $\delta_1$:
...
\item the two expressions from the previous slide now become:
