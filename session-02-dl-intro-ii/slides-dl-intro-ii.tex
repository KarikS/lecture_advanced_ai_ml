...
\begin{frame} {Rectified Linear Units (ReLU)}
  \begin{itemize}
    ...
    \begin{figure}
      \centering
        \scalebox{0.62}{\includegraphics{figure/relu_deriv.png}}
...
\begin{frame} {Rectified Linear Units (ReLU)}
  \begin{itemize}
    ...
    \begin{figure}
    \centering
      \scalebox{0.48}{\includegraphics{figure/relu_vs_tanh.png}}
...
\begin{frame} {Rectified Linear Units (ReLU)}
  ...
  \item A downside of ReLU units is that when the input to the activation is negative, the derivative is zero (the "dying ReLU problem").
    \begin{figure}
      \centering
        \scalebox{0.75}{\includegraphics{figure/relu_deriv.png}}
        \caption{ReLU activation (Savino \& Tondolo, 2021)}
    \end{figure}
...
\begin{frame} {Generalizations of ReLU}
  \begin{itemize}
    ...
    \begin{figure}
      \centering
        \scalebox{0.35}{\includegraphics{figure/leakyrelu_deriv.png}}
...
\framebreak
  ...
  % \begin{figure}
  %   \centering
  %     \includegraphics[width=11cm]{figure/early_stopping}
  %     \caption{Optimization path of early stopping (left) and weight decay (right) (Goodfellow et al. (2016))}
  % \end{figure}
  % \framebreak
  \begin{figure}
    \centering
      \scalebox{0.75}{\includegraphics{figure/earlystop_int_hat.png}}
...
\lz
  \begin{figure}
    \centering
      %\scalebox{0.75}
      {\includegraphics{figure/ridge-vs-sgd-path.png}}
